...
import swiss.pairing_strategies.min_cost as pairing_strategies_min_cost
...
class TestPairingPossibilities(unittest.TestCase):
    ...
    def test_readme_example(self):
        ...
        pairings = pairing_strategies_min_cost.pairings(match_log)
    ...
    def test_6_players_have_1_possible_pairings(self):
        ...
        self.assertEqual(
            pairing_strategies_min_cost.number_of_possible_pairings(self.match_log), 1
        )
    ...
    def test_players_face_closest_player_in_list(self):
        for i in range(6):
            self.match_log.add_player(self.players[i])
        pairings = pairing_strategies_min_cost.pairings(self.match_log)
    ...
    def test_no_players(self):
        m = pairing_strategies_min_cost.pairings(self.match_log)
    ...
    def test_smoke_pairings_string(self):
        self.match_log.add_player(self.players[0])
        self.match_log.add_player(self.players[1])
        s = pairing_strategies_min_cost.pairings(self.match_log).string()
